...
export default class Login {
  ...
  handleSubmitAdmin = (e) => {
    ...
    const user = {
      type: "Admin",
      // changement employee-email-input en admin-email-input = bon ciblage de l'input email
      email: e.target.querySelector(`input[data-testid="admin-email-input"]`)
        .value,
      // changement employee-password-input en admin-password-input = bon ciblage input password
      password: e.target.querySelector(
